...
START PROC 
	...
	MOV AL, DATO_1					; ALMACENA VALOR DE DATO_1 
	MOV BL, DATO_2					; ALMACENA VALOR DE DATO_2 	
	MUL BX 							; MULTIPLICACION DE AMBOS
	MOV FACT_DATO_1, AX				; ALMACENA RESULTADO DE LA MULTIPLICACION
	MOV CX, FACT_DATO_1				; MOVEMOS RESULTADO A OTRO REGISTRO PARA CALCULAR EL FACTORIAL
	CALL FACTOR						; LLAMAMOS A FUNCION QUE CALCULA EL FACTORIAL
